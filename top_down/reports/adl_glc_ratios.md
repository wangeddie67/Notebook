...
## 5.39 <a id="metric_dsb_switch_cost">Metric_DSB_Switch_Cost</a>
...
## 5.40 <a id="metric_ipmisp_cond_taken">Metric_IpMisp_Cond_Taken</a>
...
## 5.53 <a id="metric_load_l3_miss_latency">Metric_Load_L3_Miss_Latency</a>
...
## 5.54 <a id="metric_l2_cache_fill_bw_1t">Metric_L2_Cache_Fill_BW_1T</a>
...
## 5.55 <a id="metric_l1d_cache_fill_bw_1t">Metric_L1D_Cache_Fill_BW_1T</a>
...
## 5.56 <a id="metric_ic_misses">Metric_IC_Misses</a>
...
## 5.57 <a id="metric_code_stlb_mpki">Metric_Code_STLB_MPKI</a>
...
## 5.58 <a id="metric_ipswpf">Metric_IpSWPF</a>
...
## 5.59 <a id="metric_memory_data_tlbs">Metric_Memory_Data_TLBs</a>
...
```python
Memory_Data_TLBs = 100 * Memory_Bound * (L1_Bound / max(Memory_Bound, L1_Bound + L3_Bound + DRAM_Bound + Store_Bound + L2_Bound) * (DTLB_Load / max(L1_Bound, Store_Fwd_Blk + Split_Loads + Lock_Latency + FB_Full + DTLB_Load)) + Store_Bound / (L1_Bound + L3_Bound + DRAM_Bound + Store_Bound + L2_Bound) * (DTLB_Store / (Split_Stores + DTLB_Store + Streaming_Stores + Store_Latency + False_Sharing)))
...
## 5.60 <a id="metric_turbo_utilization">Metric_Turbo_Utilization</a>
...
## 5.61 <a id="metric_jump">Metric_Jump</a>
...
## 5.62 <a id="metric_page_walks_utilization">Metric_Page_Walks_Utilization</a>
...
## 5.63 <a id="metric_l1mpki">Metric_L1MPKI</a>
...
## 5.64 <a id="metric_cond_tk">Metric_Cond_TK</a>
...
## 5.65 <a id="metric_branching_overhead">Metric_Branching_Overhead</a>
...
## 5.66 <a id="metric_cpu_utilization">Metric_CPU_Utilization</a>
...
## 5.67 <a id="metric_slots_utilization">Metric_Slots_Utilization</a>
...
## 5.68 <a id="metric_mlp">Metric_MLP</a>
...
## 5.69 <a id="metric_l2mpki_code_all">Metric_L2MPKI_Code_All</a>
...
## 5.70 <a id="metric_ipflop">Metric_IpFLOP</a>
...
## 5.71 <a id="metric_other_branches">Metric_Other_Branches</a>
...
## 5.72 <a id="metric_l1mpki_load">Metric_L1MPKI_Load</a>
...
## 5.73 <a id="metric_core_bound_likely">Metric_Core_Bound_Likely</a>
...
## 5.74 <a id="metric_iptb">Metric_IpTB</a>
...
## 5.75 <a id="metric_ipassist">Metric_IpAssist</a>
...
## 5.76 <a id="metric_strings_cycles">Metric_Strings_Cycles</a>
...
## 5.77 <a id="metric_execute">Metric_Execute</a>
...
## 5.78 <a id="metric_slots">Metric_SLOTS</a>
...
## 5.79 <a id="metric_big_code">Metric_Big_Code</a>
...
## 5.80 <a id="metric_l3_cache_access_bw_1t">Metric_L3_Cache_Access_BW_1T</a>
...
## 5.81 <a id="metric_smt_2t_utilization">Metric_SMT_2T_Utilization</a>
...
## 5.82 <a id="metric_load_l2_miss_latency">Metric_Load_L2_Miss_Latency</a>
...
## 5.83 <a id="metric_fp_arith_utilization">Metric_FP_Arith_Utilization</a>
...
## 5.84 <a id="metric_core_clks">Metric_CORE_CLKS</a>
...
## 5.85 <a id="metric_icache_miss_latency">Metric_ICache_Miss_Latency</a>
...
## 5.86 <a id="metric_l2mpki_code">Metric_L2MPKI_Code</a>
...
## 5.87 <a id="metric_ipdsb_miss_ret">Metric_IpDSB_Miss_Ret</a>
...
## 5.88 <a id="metric_l3_cache_access_bw">Metric_L3_Cache_Access_BW</a>
...
## 5.89 <a id="metric_ipmisp_indirect">Metric_IpMisp_Indirect</a>
...
```python
IpMisp_Indirect = INST_RETIRED.ANY / BR_MISP_RETIRED.INDIRECT_CALL:u0x80
Metric_IpMisp_Indirect = IpMisp_Indirect
```

- INST_RETIRED.ANY
- BR_MISP_RETIRED.INDIRECT_CALL:u0x80
...
## 5.94 <a id="metric_ipmisp_ret">Metric_IpMisp_Ret</a>
...
## 5.97 <a id="metric_load_l2_mlp">Metric_Load_L2_MLP</a>
...
## 5.98 <a id="metric_memory_latency">Metric_Memory_Latency</a>
...
## 5.99 <a id="metric_lsd_coverage">Metric_LSD_Coverage</a>
