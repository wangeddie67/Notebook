...
Mem_XSNP_HitM_Cost = 60
CLKS = CPU_CLK_UNHALTED.THREAD
False_Sharing = Mem_XSNP_HitM_Cost * OFFCORE_RESPONSE.DEMAND_RFO.L3_HIT.SNOOP_HITM / CLKS
```
...
## 5.14 <a id="metric_load_l2_miss_latency">Metric_Load_L2_Miss_Latency</a>
...
## 5.15 <a id="metric_ipstore">Metric_IpStore</a>
...
## 5.16 <a id="metric_uoppi">Metric_UopPI</a>
...
## 5.17 <a id="metric_l2hpki_all">Metric_L2HPKI_All</a>
...
## 5.18 <a id="metric_turbo_utilization">Metric_Turbo_Utilization</a>
...
## 5.19 <a id="metric_data_l2_mlp">Metric_Data_L2_MLP</a>
...
## 5.20 <a id="metric_page_walks_utilization">Metric_Page_Walks_Utilization</a>
...
CLKS = CPU_CLK_UNHALTED.THREAD
CORE_CLKS = CPU_CLK_UNHALTED.THREAD / 2 * (1 + CPU_CLK_UNHALTED.ONE_THREAD_ACTIVE / CPU_CLK_UNHALTED.REF_XCLK) if ebs_mode else CPU_CLK_UNHALTED.THREAD_ANY / 2 if smt_enabled else CLKS
Page_Walks_Utilization = (ITLB_MISSES.WALK_DURATION:c1 + DTLB_LOAD_MISSES.WALK_DURATION:c1 + DTLB_STORE_MISSES.WALK_DURATION:c1 + 7 * (DTLB_STORE_MISSES.WALK_COMPLETED + DTLB_LOAD_MISSES.WALK_COMPLETED + ITLB_MISSES.WALK_COMPLETED)) / CORE_CLKS
...
## 5.21 <a id="metric_fp_arith_utilization">Metric_FP_Arith_Utilization</a>
...
## 5.22 <a id="metric_core_clks">Metric_CORE_CLKS</a>
...
## 5.23 <a id="metric_l2hpki_load">Metric_L2HPKI_Load</a>
...
## 5.24 <a id="metric_l2mpki">Metric_L2MPKI</a>
...
## 5.25 <a id="metric_l1mpki">Metric_L1MPKI</a>
...
## 5.26 <a id="metric_ilp">Metric_ILP</a>
...
## 5.27 <a id="metric_ipunknown_branch">Metric_IpUnknown_Branch</a>
...
## 5.28 <a id="metric_ipfarbranch">Metric_IpFarBranch</a>
...
## 5.29 <a id="metric_kernel_utilization">Metric_Kernel_Utilization</a>
...
## 5.30 <a id="metric_cpu_utilization">Metric_CPU_Utilization</a>
...
## 5.31 <a id="metric_flopc">Metric_FLOPc</a>
...
## 5.32 <a id="metric_mlp">Metric_MLP</a>
...
## 5.33 <a id="metric_instructions">Metric_Instructions</a>
...
## 5.34 <a id="metric_gflops">Metric_GFLOPs</a>
...
## 5.35 <a id="metric_iparith_scalar_sp">Metric_IpArith_Scalar_SP</a>
...
## 5.36 <a id="metric_socket_clks">Metric_Socket_CLKS</a>
...
## 5.37 <a id="metric_ipc">Metric_IPC</a>
...
## 5.38 <a id="metric_ipmisp_indirect">Metric_IpMisp_Indirect</a>
...
## 5.39 <a id="metric_ipflop">Metric_IpFLOP</a>
...
## 5.40 <a id="metric_kernel_cpi">Metric_Kernel_CPI</a>
...
## 5.41 <a id="metric_iparith_scalar_dp">Metric_IpArith_Scalar_DP</a>
...
## 5.42 <a id="metric_l2_cache_fill_bw">Metric_L2_Cache_Fill_BW</a>
...
## 5.43 <a id="metric_mem_request_latency">Metric_MEM_Request_Latency</a>
...
## 5.44 <a id="metric_ipbranch">Metric_IpBranch</a>
...
## 5.45 <a id="metric_branch_misprediction_cost">Metric_Branch_Misprediction_Cost</a>
...
## 5.46 <a id="metric_coreipc">Metric_CoreIPC</a>
...
## 5.48 <a id="metric_mem_parallel_requests">Metric_MEM_Parallel_Requests</a>
