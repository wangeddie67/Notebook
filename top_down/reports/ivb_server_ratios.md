...
## 5.29 <a id="metric_mlp">Metric_MLP</a>
...
## 5.30 <a id="metric_instructions">Metric_Instructions</a>
...
## 5.31 <a id="metric_gflops">Metric_GFLOPs</a>
...
## 5.32 <a id="metric_socket_clks">Metric_Socket_CLKS</a>
...
## 5.33 <a id="metric_ipc">Metric_IPC</a>
...
## 5.34 <a id="metric_ipmisp_indirect">Metric_IpMisp_Indirect</a>
...
## 5.35 <a id="metric_kernel_cpi">Metric_Kernel_CPI</a>
...
## 5.36 <a id="metric_l2_cache_fill_bw">Metric_L2_Cache_Fill_BW</a>
...
## 5.37 <a id="metric_ipbranch">Metric_IpBranch</a>
...
## 5.38 <a id="metric_coreipc">Metric_CoreIPC</a>
...
## 5.45 <a id="metric_bptkbranch">Metric_BpTkBranch</a>
...
## 5.46 <a id="metric_load_l2_mlp">Metric_Load_L2_MLP</a>
...
## 5.47 <a id="metric_time">Metric_Time</a>
...
## 5.48 <a id="metric_execute_per_issue">Metric_Execute_per_Issue</a>
...
## 5.49 <a id="metric_ipmispredict">Metric_IpMispredict</a>
...
## 5.50 <a id="metric_l1d_cache_fill_bw">Metric_L1D_Cache_Fill_BW</a>
...
## 5.51 <a id="metric_iparith">Metric_IpArith</a>
...
## 5.52 <a id="metric_retire">Metric_Retire</a>
...
## 5.53 <a id="metric_l3mpki">Metric_L3MPKI</a>
...
```python
L3MPKI = 1000 * MEM_LOAD_UOPS_RETIRED.LLC_MISS / INST_RETIRED.ANY
