...
This metric estimates fraction of cycles where the Advanced Matrix Extensions (AMX) execution engine was busy with tile (arithmetic) operations
...
#### 4.1.2.4 <a id="shuffles">Shuffles</a>
...
## 5.8 <a id="metric_mem_read_latency">Metric_MEM_Read_Latency</a>
...
## 5.9 <a id="metric_ipstore">Metric_IpStore</a>
...
## 5.10 <a id="metric_load_stlb_mpki">Metric_Load_STLB_MPKI</a>
...
## 5.11 <a id="metric_data_l2_mlp">Metric_Data_L2_MLP</a>
...
## 5.12 <a id="metric_l2hpki_load">Metric_L2HPKI_Load</a>
...
## 5.13 <a id="metric_ilp">Metric_ILP</a>
...
## 5.14 <a id="metric_fetch_upc">Metric_Fetch_UpC</a>
...
## 5.15 <a id="metric_fb_hpki">Metric_FB_HPKI</a>
...
## 5.16 <a id="metric_l2_evictions_nonsilent_pki">Metric_L2_Evictions_NonSilent_PKI</a>
...
## 5.17 <a id="metric_gflops">Metric_GFLOPs</a>
...
## 5.18 <a id="metric_iparith_scalar_sp">Metric_IpArith_Scalar_SP</a>
...
## 5.19 <a id="metric_socket_clks">Metric_Socket_CLKS</a>
...
## 5.20 <a id="metric_ipc">Metric_IPC</a>
...
## 5.21 <a id="metric_ipbranch">Metric_IpBranch</a>
...
## 5.22 <a id="metric_coreipc">Metric_CoreIPC</a>
...
```python
IpArith_AVX256 = INST_RETIRED.ANY / (FP_ARITH_INST_RETIRED.256B_PACKED_DOUBLE + FP_ARITH_INST_RETIRED.256B_PACKED_SINGLE + FP_ARITH_INST_RETIRED2.256B_PACKED_HALF)
...
## 5.31 <a id="metric_memory_bandwidth">Metric_Memory_Bandwidth</a>
...
## 5.32 <a id="metric_uoppi">Metric_UopPI</a>
...
## 5.33 <a id="metric_l2hpki_all">Metric_L2HPKI_All</a>
...
## 5.40 <a id="metric_instructions">Metric_Instructions</a>
...
## 5.41 <a id="metric_iparith_amx_int8">Metric_IpArith_AMX_Int8</a>
...
- Threshold:  < 10
- Area: Info.Inst_Mix
- Metric group: IntVector, InsType, Server

```python
IpArith_AMX_Int8 = INST_RETIRED.ANY / AMX_OPS_RETIRED.INT8
Metric_IpArith_AMX_Int8 = IpArith_AMX_Int8
```
...
## 5.44 <a id="metric_dsb_switch_cost">Metric_DSB_Switch_Cost</a>
...
## 5.45 <a id="metric_ipmisp_cond_taken">Metric_IpMisp_Cond_Taken</a>
...
## 5.46 <a id="metric_pmm_read_bw">Metric_PMM_Read_BW</a>
...
```python
Time = interval-s
PMM_Read_BW = 64 * UNC_M_PMM_RPQ_INSERTS / OneBillion / Time
...
## 5.47 <a id="metric_callret">Metric_CallRet</a>
...
## 5.48 <a id="metric_mem_pmm_read_latency">Metric_MEM_PMM_Read_Latency</a>
...
```python
MEM_PMM_Read_Latency = OneBillion * (UNC_CHA_TOR_OCCUPANCY.IA_MISS_DRD_PMM / UNC_CHA_TOR_INSERTS.IA_MISS_DRD_PMM) / UNC_CHA_CLOCKTICKS:one_unit
...
## 5.49 <a id="metric_clks">Metric_CLKS</a>
...
## 5.50 <a id="metric_dsb_coverage">Metric_DSB_Coverage</a>
...
## 5.51 <a id="metric_dsb_misses">Metric_DSB_Misses</a>
...
## 5.52 <a id="metric_time">Metric_Time</a>
...
## 5.53 <a id="metric_l1d_cache_fill_bw">Metric_L1D_Cache_Fill_BW</a>
...
## 5.54 <a id="metric_iparith">Metric_IpArith</a>
...
## 5.55 <a id="metric_retire">Metric_Retire</a>
...
## 5.56 <a id="metric_l3mpki">Metric_L3MPKI</a>
...
## 5.57 <a id="metric_cpi">Metric_CPI</a>
...
## 5.58 <a id="metric_l2mpki_load">Metric_L2MPKI_Load</a>
...
## 5.59 <a id="metric_ipload">Metric_IpLoad</a>
...
## 5.60 <a id="metric_load_l3_miss_latency">Metric_Load_L3_Miss_Latency</a>
...
```python
Load_L3_Miss_Latency = OFFCORE_REQUESTS_OUTSTANDING.L3_MISS_DEMAND_DATA_RD / OFFCORE_REQUESTS.L3_MISS_DEMAND_DATA_RD
...
## 5.61 <a id="metric_l2_cache_fill_bw_1t">Metric_L2_Cache_Fill_BW_1T</a>
...
## 5.62 <a id="metric_l1d_cache_fill_bw_1t">Metric_L1D_Cache_Fill_BW_1T</a>
...
## 5.63 <a id="metric_ic_misses">Metric_IC_Misses</a>
...
## 5.64 <a id="metric_code_stlb_mpki">Metric_Code_STLB_MPKI</a>
...
## 5.65 <a id="metric_ipswpf">Metric_IpSWPF</a>
...
## 5.66 <a id="metric_memory_data_tlbs">Metric_Memory_Data_TLBs</a>
...
## 5.67 <a id="metric_turbo_utilization">Metric_Turbo_Utilization</a>
...
## 5.68 <a id="metric_jump">Metric_Jump</a>
...
## 5.69 <a id="metric_page_walks_utilization">Metric_Page_Walks_Utilization</a>
...
```python
CORE_CLKS = CPU_CLK_UNHALTED.DISTRIBUTED
Page_Walks_Utilization = (ITLB_MISSES.WALK_PENDING + DTLB_LOAD_MISSES.WALK_PENDING + DTLB_STORE_MISSES.WALK_PENDING) / (4 * CORE_CLKS)
...
## 5.70 <a id="metric_l1mpki">Metric_L1MPKI</a>
...
## 5.71 <a id="metric_cond_tk">Metric_Cond_TK</a>
...
## 5.72 <a id="metric_branching_overhead">Metric_Branching_Overhead</a>
...
## 5.73 <a id="metric_cpu_utilization">Metric_CPU_Utilization</a>
...
## 5.74 <a id="metric_mem_parallel_reads">Metric_MEM_Parallel_Reads</a>
...
## 5.75 <a id="metric_slots_utilization">Metric_Slots_Utilization</a>
...
## 5.76 <a id="metric_mlp">Metric_MLP</a>
...
## 5.77 <a id="metric_l2mpki_code_all">Metric_L2MPKI_Code_All</a>
...
## 5.78 <a id="metric_ipflop">Metric_IpFLOP</a>
...
## 5.79 <a id="metric_other_branches">Metric_Other_Branches</a>
...
## 5.80 <a id="metric_l1mpki_load">Metric_L1MPKI_Load</a>
...
## 5.81 <a id="metric_core_bound_likely">Metric_Core_Bound_Likely</a>
...
## 5.82 <a id="metric_iptb">Metric_IpTB</a>
...
## 5.83 <a id="metric_pmm_write_bw">Metric_PMM_Write_BW</a>
...
```python
Time = interval-s
PMM_Write_BW = 64 * UNC_M_PMM_WPQ_INSERTS / OneBillion / Time
...
## 5.84 <a id="metric_ipassist">Metric_IpAssist</a>
...
```python
IpAssist = INST_RETIRED.ANY / ASSISTS.ANY:u0x1B
Metric_IpAssist = IpAssist
```

- INST_RETIRED.ANY
- ASSISTS.ANY:u0x1B

## 5.85 <a id="metric_tiops">Metric_TIOPS</a>
...
- Threshold: True
- Area: Info.System
- Metric group: Cor, HPC, IntVector, Server

```python
Time = interval-s
TIOPS = 8 * AMX_OPS_RETIRED.INT8 / 1000000000000.0 / Time
Metric_TIOPS = TIOPS
```
...
## 5.86 <a id="metric_strings_cycles">Metric_Strings_Cycles</a>
...
```python
Strings_Cycles = INST_RETIRED.REP_ITERATION / UOPS_RETIRED.SLOTS:c1
Metric_Strings_Cycles = Strings_Cycles
```

- INST_RETIRED.REP_ITERATION
- UOPS_RETIRED.SLOTS:c1

## 5.87 <a id="metric_execute">Metric_Execute</a>
...
## 5.88 <a id="metric_slots">Metric_SLOTS</a>
...
## 5.89 <a id="metric_big_code">Metric_Big_Code</a>
...
## 5.90 <a id="metric_l3_cache_access_bw_1t">Metric_L3_Cache_Access_BW_1T</a>
...
## 5.91 <a id="metric_smt_2t_utilization">Metric_SMT_2T_Utilization</a>
...
## 5.92 <a id="metric_load_l2_miss_latency">Metric_Load_L2_Miss_Latency</a>
...
## 5.93 <a id="metric_fp_arith_utilization">Metric_FP_Arith_Utilization</a>
...
```python
CORE_CLKS = CPU_CLK_UNHALTED.DISTRIBUTED
FP_Arith_Utilization = (FP_ARITH_DISPATCHED.PORT_0 + FP_ARITH_DISPATCHED.PORT_1 + FP_ARITH_DISPATCHED.PORT_5) / (2 * CORE_CLKS)
...
## 5.94 <a id="metric_core_clks">Metric_CORE_CLKS</a>
...
## 5.95 <a id="metric_icache_miss_latency">Metric_ICache_Miss_Latency</a>
...
```python
ICache_Miss_Latency = ICACHE_DATA.STALLS / ICACHE_DATA.STALLS:c1:e1
Metric_ICache_Miss_Latency = ICache_Miss_Latency
```

- ICACHE_DATA.STALLS:c1:e1
- ICACHE_DATA.STALLS

## 5.96 <a id="metric_l2mpki_code">Metric_L2MPKI_Code</a>
...
## 5.97 <a id="metric_ipdsb_miss_ret">Metric_IpDSB_Miss_Ret</a>
...
## 5.98 <a id="metric_l3_cache_access_bw">Metric_L3_Cache_Access_BW</a>
...
## 5.99 <a id="metric_ipmisp_indirect">Metric_IpMisp_Indirect</a>
...
## 5.100 <a id="metric_l2_cache_fill_bw">Metric_L2_Cache_Fill_BW</a>
...
## 5.101 <a id="metric_branch_misprediction_cost">Metric_Branch_Misprediction_Cost</a>
...
## 5.102 <a id="metric_l2mpki_all">Metric_L2MPKI_All</a>
...
## 5.103 <a id="metric_load_miss_real_latency">Metric_Load_Miss_Real_Latency</a>
...
## 5.104 <a id="metric_iparith_avx512">Metric_IpArith_AVX512</a>
...
```python
IpArith_AVX512 = INST_RETIRED.ANY / (FP_ARITH_INST_RETIRED.512B_PACKED_DOUBLE + FP_ARITH_INST_RETIRED.512B_PACKED_SINGLE + FP_ARITH_INST_RETIRED2.512B_PACKED_HALF)
...
## 5.105 <a id="metric_ipmisp_ret">Metric_IpMisp_Ret</a>
...
## 5.106 <a id="metric_l3_cache_fill_bw_1t">Metric_L3_Cache_Fill_BW_1T</a>
...
## 5.107 <a id="metric_instruction_fetch_bw">Metric_Instruction_Fetch_BW</a>
...
## 5.108 <a id="metric_io_write_bw">Metric_IO_Write_BW</a>
...
## 5.109 <a id="metric_load_l2_mlp">Metric_Load_L2_MLP</a>
...
## 5.110 <a id="metric_memory_latency">Metric_Memory_Latency</a>
...
## 5.111 <a id="metric_mem_dram_read_latency">Metric_MEM_DRAM_Read_Latency</a>
