...
DRAM_Bound = MEM_Bound_Ratio - PMM_Bound
```
...
Average_Frequency = Turbo_Utilization * msr/tsc/ / OneBillion / Time
Mem_XSNP_HitM_Cost = 22 * Average_Frequency
OCR_all_rfo_l3_hit_snoop_hitm = OCR.DEMAND_RFO.L3_HIT.HITM_OTHER_CORE + OCR.PF_L2_RFO.L3_HIT.HITM_OTHER_CORE
...
#### 3.1.6.4 <a id="dtlb_store">DTLB_Store</a>
...
##### 3.1.6.4.1 <a id="store_stlb_hit">Store_STLB_Hit</a>
...
##### 3.1.6.4.2 <a id="store_stlb_miss">Store_STLB_Miss</a>
...
```python
CLKS = CPU_CLK_UNHALTED.THREAD
Slow_Pause = 40 * ROB_MISC_EVENTS.PAUSE_INST / CLKS
```
...
## 5.4 <a id="metric_l2_evictions_silent_pki">Metric_L2_Evictions_Silent_PKI</a>
...
## 5.13 <a id="metric_l2_evictions_nonsilent_pki">Metric_L2_Evictions_NonSilent_PKI</a>
...
## 5.15 <a id="metric_iparith_scalar_sp">Metric_IpArith_Scalar_SP</a>
...
## 5.16 <a id="metric_socket_clks">Metric_Socket_CLKS</a>
...
## 5.17 <a id="metric_ipc">Metric_IPC</a>
...
## 5.18 <a id="metric_ipbranch">Metric_IpBranch</a>
...
## 5.20 <a id="metric_io_read_bw">Metric_IO_Read_BW</a>
...
```python
Time = interval-s
IO_Read_BW = (UNC_IIO_DATA_REQ_OF_CPU.MEM_WRITE.PART0 + UNC_IIO_DATA_REQ_OF_CPU.MEM_WRITE.PART1 + UNC_IIO_DATA_REQ_OF_CPU.MEM_WRITE.PART2 + UNC_IIO_DATA_REQ_OF_CPU.MEM_WRITE.PART3) * 4 / OneBillion / Time
...
## 5.22 <a id="metric_bptkbranch">Metric_BpTkBranch</a>
...
## 5.23 <a id="metric_execute_per_issue">Metric_Execute_per_Issue</a>
...
## 5.24 <a id="metric_ipmispredict">Metric_IpMispredict</a>
...
## 5.25 <a id="metric_iparith_avx256">Metric_IpArith_AVX256</a>
...
## 5.26 <a id="metric_uptb">Metric_UpTB</a>
...
## 5.27 <a id="metric_mispredictions">Metric_Mispredictions</a>
...
## 5.28 <a id="metric_cond_nt">Metric_Cond_NT</a>
...
## 5.29 <a id="metric_power_license0_utilization">Metric_Power_License0_Utilization</a>
...
CLKS = CPU_CLK_UNHALTED.THREAD
CORE_CLKS = CPU_CLK_UNHALTED.THREAD / 2 * (1 + CPU_CLK_UNHALTED.ONE_THREAD_ACTIVE / CPU_CLK_UNHALTED.REF_XCLK) if ebs_mode else CPU_CLK_UNHALTED.THREAD_ANY / 2 if smt_enabled else CLKS
Power_License0_Utilization = CORE_POWER.LVL0_TURBO_LICENSE / 2 / CORE_CLKS if smt_enabled else CORE_POWER.LVL0_TURBO_LICENSE / CORE_CLKS
...
## 5.30 <a id="metric_memory_bandwidth">Metric_Memory_Bandwidth</a>
...
## 5.31 <a id="metric_uoppi">Metric_UopPI</a>
...
## 5.32 <a id="metric_l2hpki_all">Metric_L2HPKI_All</a>
...
## 5.33 <a id="metric_l2mpki">Metric_L2MPKI</a>
...
## 5.34 <a id="metric_ipunknown_branch">Metric_IpUnknown_Branch</a>
...
## 5.35 <a id="metric_store_stlb_mpki">Metric_Store_STLB_MPKI</a>
...
## 5.36 <a id="metric_kernel_utilization">Metric_Kernel_Utilization</a>
...
## 5.37 <a id="metric_ipfarbranch">Metric_IpFarBranch</a>
...
## 5.38 <a id="metric_flopc">Metric_FLOPc</a>
...
## 5.39 <a id="metric_power_license2_utilization">Metric_Power_License2_Utilization</a>
...
CLKS = CPU_CLK_UNHALTED.THREAD
CORE_CLKS = CPU_CLK_UNHALTED.THREAD / 2 * (1 + CPU_CLK_UNHALTED.ONE_THREAD_ACTIVE / CPU_CLK_UNHALTED.REF_XCLK) if ebs_mode else CPU_CLK_UNHALTED.THREAD_ANY / 2 if smt_enabled else CLKS
Power_License2_Utilization = CORE_POWER.LVL2_TURBO_LICENSE / 2 / CORE_CLKS if smt_enabled else CORE_POWER.LVL2_TURBO_LICENSE / CORE_CLKS
...
## 5.41 <a id="metric_kernel_cpi">Metric_Kernel_CPI</a>
...
## 5.42 <a id="metric_iparith_scalar_dp">Metric_IpArith_Scalar_DP</a>
...
## 5.43 <a id="metric_power_license1_utilization">Metric_Power_License1_Utilization</a>
...
CLKS = CPU_CLK_UNHALTED.THREAD
CORE_CLKS = CPU_CLK_UNHALTED.THREAD / 2 * (1 + CPU_CLK_UNHALTED.ONE_THREAD_ACTIVE / CPU_CLK_UNHALTED.REF_XCLK) if ebs_mode else CPU_CLK_UNHALTED.THREAD_ANY / 2 if smt_enabled else CLKS
Power_License1_Utilization = CORE_POWER.LVL1_TURBO_LICENSE / 2 / CORE_CLKS if smt_enabled else CORE_POWER.LVL1_TURBO_LICENSE / CORE_CLKS
...
## 5.45 <a id="metric_pmm_read_bw">Metric_PMM_Read_BW</a>
...
## 5.46 <a id="metric_callret">Metric_CallRet</a>
...
## 5.47 <a id="metric_mem_pmm_read_latency">Metric_MEM_PMM_Read_Latency</a>
...
```python
MEM_PMM_Read_Latency = OneBillion * (UNC_M_PMM_RPQ_OCCUPANCY.ALL / UNC_M_PMM_RPQ_INSERTS) / UNC_M_CLOCKTICKS:one_unit
Metric_MEM_PMM_Read_Latency = MEM_PMM_Read_Latency
```

- UNC_M_CLOCKTICKS:one_unit
- UNC_M_PMM_RPQ_OCCUPANCY.ALL
- OneBillion
- UNC_M_PMM_RPQ_INSERTS

## 5.48 <a id="metric_clks">Metric_CLKS</a>
...
## 5.49 <a id="metric_dsb_coverage">Metric_DSB_Coverage</a>
...
```python
Fetched_Uops = IDQ.DSB_UOPS + IDQ.MITE_UOPS + IDQ.MS_UOPS
...
## 5.50 <a id="metric_dsb_misses">Metric_DSB_Misses</a>
...
## 5.51 <a id="metric_time">Metric_Time</a>
...
## 5.52 <a id="metric_l1d_cache_fill_bw">Metric_L1D_Cache_Fill_BW</a>
...
## 5.53 <a id="metric_iparith">Metric_IpArith</a>
...
## 5.54 <a id="metric_retire">Metric_Retire</a>
...
## 5.55 <a id="metric_l3mpki">Metric_L3MPKI</a>
...
## 5.56 <a id="metric_cpi">Metric_CPI</a>
...
## 5.57 <a id="metric_l2mpki_load">Metric_L2MPKI_Load</a>
...
## 5.58 <a id="metric_ipload">Metric_IpLoad</a>
...
## 5.59 <a id="metric_l2_cache_fill_bw_1t">Metric_L2_Cache_Fill_BW_1T</a>
...
## 5.60 <a id="metric_l1d_cache_fill_bw_1t">Metric_L1D_Cache_Fill_BW_1T</a>
...
## 5.61 <a id="metric_ic_misses">Metric_IC_Misses</a>
...
## 5.62 <a id="metric_code_stlb_mpki">Metric_Code_STLB_MPKI</a>
...
## 5.63 <a id="metric_ipswpf">Metric_IpSWPF</a>
...
## 5.64 <a id="metric_memory_data_tlbs">Metric_Memory_Data_TLBs</a>
...
## 5.65 <a id="metric_turbo_utilization">Metric_Turbo_Utilization</a>
...
## 5.66 <a id="metric_jump">Metric_Jump</a>
...
## 5.67 <a id="metric_page_walks_utilization">Metric_Page_Walks_Utilization</a>
...
## 5.68 <a id="metric_l1mpki">Metric_L1MPKI</a>
...
## 5.69 <a id="metric_cond_tk">Metric_Cond_TK</a>
...
## 5.70 <a id="metric_branching_overhead">Metric_Branching_Overhead</a>
...
## 5.71 <a id="metric_cpu_utilization">Metric_CPU_Utilization</a>
...
## 5.72 <a id="metric_mlp">Metric_MLP</a>
...
## 5.73 <a id="metric_l2mpki_code_all">Metric_L2MPKI_Code_All</a>
...
## 5.74 <a id="metric_ipflop">Metric_IpFLOP</a>
...
## 5.75 <a id="metric_l1mpki_load">Metric_L1MPKI_Load</a>
...
## 5.76 <a id="metric_core_bound_likely">Metric_Core_Bound_Likely</a>
...
## 5.77 <a id="metric_iptb">Metric_IpTB</a>
...
## 5.78 <a id="metric_pmm_write_bw">Metric_PMM_Write_BW</a>
...
## 5.79 <a id="metric_execute">Metric_Execute</a>
...
## 5.80 <a id="metric_slots">Metric_SLOTS</a>
...
## 5.81 <a id="metric_big_code">Metric_Big_Code</a>
...
## 5.82 <a id="metric_l3_cache_access_bw_1t">Metric_L3_Cache_Access_BW_1T</a>
...
## 5.83 <a id="metric_smt_2t_utilization">Metric_SMT_2T_Utilization</a>
...
## 5.84 <a id="metric_load_l2_miss_latency">Metric_Load_L2_Miss_Latency</a>
...
## 5.85 <a id="metric_fp_arith_utilization">Metric_FP_Arith_Utilization</a>
...
## 5.86 <a id="metric_core_clks">Metric_CORE_CLKS</a>
...
## 5.87 <a id="metric_icache_miss_latency">Metric_ICache_Miss_Latency</a>
...
## 5.88 <a id="metric_l2mpki_code">Metric_L2MPKI_Code</a>
...
## 5.89 <a id="metric_ipdsb_miss_ret">Metric_IpDSB_Miss_Ret</a>
...
## 5.90 <a id="metric_l3_cache_access_bw">Metric_L3_Cache_Access_BW</a>
...
## 5.91 <a id="metric_l2_cache_fill_bw">Metric_L2_Cache_Fill_BW</a>
...
## 5.92 <a id="metric_branch_misprediction_cost">Metric_Branch_Misprediction_Cost</a>
...
## 5.93 <a id="metric_l2mpki_all">Metric_L2MPKI_All</a>
...
## 5.94 <a id="metric_load_miss_real_latency">Metric_Load_Miss_Real_Latency</a>
...
## 5.95 <a id="metric_iparith_avx512">Metric_IpArith_AVX512</a>
...
## 5.96 <a id="metric_l3_cache_fill_bw_1t">Metric_L3_Cache_Fill_BW_1T</a>
...
## 5.97 <a id="metric_instruction_fetch_bw">Metric_Instruction_Fetch_BW</a>
...
## 5.98 <a id="metric_io_write_bw">Metric_IO_Write_BW</a>
...
```python
Time = interval-s
IO_Write_BW = (UNC_IIO_DATA_REQ_OF_CPU.MEM_READ.PART0 + UNC_IIO_DATA_REQ_OF_CPU.MEM_READ.PART1 + UNC_IIO_DATA_REQ_OF_CPU.MEM_READ.PART2 + UNC_IIO_DATA_REQ_OF_CPU.MEM_READ.PART3) * 4 / OneBillion / Time
...
## 5.99 <a id="metric_load_l2_mlp">Metric_Load_L2_MLP</a>
...
## 5.100 <a id="metric_memory_latency">Metric_Memory_Latency</a>
...
## 5.101 <a id="metric_mem_dram_read_latency">Metric_MEM_DRAM_Read_Latency</a>
...
```python
MEM_DRAM_Read_Latency = OneBillion * (UNC_M_RPQ_OCCUPANCY / UNC_M_RPQ_INSERTS) / UNC_M_CLOCKTICKS:one_unit
