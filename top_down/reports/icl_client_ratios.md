...
## 5.19 <a id="metric_execute_per_issue">Metric_Execute_per_Issue</a>
...
## 5.22 <a id="metric_uptb">Metric_UpTB</a>
...
## 5.27 <a id="metric_uoppi">Metric_UopPI</a>
...
## 5.36 <a id="metric_kernel_cpi">Metric_Kernel_CPI</a>
...
## 5.37 <a id="metric_iparith_scalar_dp">Metric_IpArith_Scalar_DP</a>
...
## 5.38 <a id="metric_power_license1_utilization">Metric_Power_License1_Utilization</a>
...
```python
Memory_Data_TLBs = 100 * Memory_Bound * (L1_Bound / max(Memory_Bound, L1_Bound + L3_Bound + DRAM_Bound + Store_Bound + L2_Bound) * (DTLB_Load / max(L1_Bound, Store_Fwd_Blk + DTLB_Load + G4K_Aliasing + Lock_Latency + Split_Loads + FB_Full)) + Store_Bound / (L1_Bound + L3_Bound + DRAM_Bound + Store_Bound + L2_Bound) * (DTLB_Store / (Split_Stores + DTLB_Store + Streaming_Stores + Store_Latency + False_Sharing)))
...
## 5.75 <a id="metric_execute">Metric_Execute</a>
...
## 5.76 <a id="metric_slots">Metric_SLOTS</a>
...
## 5.77 <a id="metric_big_code">Metric_Big_Code</a>
...
## 5.78 <a id="metric_l3_cache_access_bw_1t">Metric_L3_Cache_Access_BW_1T</a>
...
## 5.79 <a id="metric_smt_2t_utilization">Metric_SMT_2T_Utilization</a>
...
## 5.80 <a id="metric_load_l2_miss_latency">Metric_Load_L2_Miss_Latency</a>
...
## 5.81 <a id="metric_fp_arith_utilization">Metric_FP_Arith_Utilization</a>
...
## 5.82 <a id="metric_core_clks">Metric_CORE_CLKS</a>
...
## 5.83 <a id="metric_icache_miss_latency">Metric_ICache_Miss_Latency</a>
...
## 5.84 <a id="metric_l2mpki_code">Metric_L2MPKI_Code</a>
...
## 5.85 <a id="metric_ipdsb_miss_ret">Metric_IpDSB_Miss_Ret</a>
...
## 5.86 <a id="metric_l3_cache_access_bw">Metric_L3_Cache_Access_BW</a>
...
## 5.87 <a id="metric_ipmisp_indirect">Metric_IpMisp_Indirect</a>
...
## 5.88 <a id="metric_l2_cache_fill_bw">Metric_L2_Cache_Fill_BW</a>
...
## 5.89 <a id="metric_branch_misprediction_cost">Metric_Branch_Misprediction_Cost</a>
...
## 5.90 <a id="metric_l2mpki_all">Metric_L2MPKI_All</a>
...
## 5.91 <a id="metric_load_miss_real_latency">Metric_Load_Miss_Real_Latency</a>
...
## 5.92 <a id="metric_iparith_avx512">Metric_IpArith_AVX512</a>
...
## 5.93 <a id="metric_l3_cache_fill_bw_1t">Metric_L3_Cache_Fill_BW_1T</a>
...
## 5.94 <a id="metric_instruction_fetch_bw">Metric_Instruction_Fetch_BW</a>
...
## 5.95 <a id="metric_load_l2_mlp">Metric_Load_L2_MLP</a>
...
## 5.96 <a id="metric_memory_latency">Metric_Memory_Latency</a>
...
## 5.97 <a id="metric_lsd_coverage">Metric_LSD_Coverage</a>
