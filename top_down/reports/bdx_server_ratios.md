...
```python
ITLB_Miss_Cycles = 14 * ITLB_MISSES.STLB_HIT + ITLB_MISSES.WALK_DURATION:c1 + 7 * ITLB_MISSES.WALK_COMPLETED
CLKS = CPU_CLK_UNHALTED.THREAD
...
```python
Mispredicts_Resteers = BR_MISP_RETIRED.ALL_BRANCHES * Branch_Resteers / (BR_MISP_RETIRED.ALL_BRANCHES + MACHINE_CLEARS.COUNT + BACLEARS.ANY)
```
...
```python
Clears_Resteers = MACHINE_CLEARS.COUNT * Branch_Resteers / (BR_MISP_RETIRED.ALL_BRANCHES + MACHINE_CLEARS.COUNT + BACLEARS.ANY)
```
...
```python
Unknown_Branches = Branch_Resteers - Mispredicts_Resteers - Clears_Resteers
```

- [Mispredicts_Resteers](#mispredicts_resteers)
- [Clears_Resteers](#clears_resteers)
- [Branch_Resteers](#branch_resteers)
...
```python
CLKS = CPU_CLK_UNHALTED.THREAD
DTLB_Load = (Mem_STLB_Hit_Cost * DTLB_LOAD_MISSES.STLB_HIT + DTLB_LOAD_MISSES.WALK_DURATION:c1 + 7 * DTLB_LOAD_MISSES.WALK_COMPLETED) / CLKS
```
...
```python
CLKS = CPU_CLK_UNHALTED.THREAD
L2_Bound = (CYCLE_ACTIVITY.STALLS_L1D_MISS - CYCLE_ACTIVITY.STALLS_L2_MISS) / CLKS
```
...
CLKS = CPU_CLK_UNHALTED.THREAD
L3_Bound = Mem_L3_Hit_Fraction * CYCLE_ACTIVITY.STALLS_L2_MISS / CLKS
```
...
LOAD_L1_MISS_NET = LOAD_L1_MISS + MEM_LOAD_UOPS_L3_MISS_RETIRED.LOCAL_DRAM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_DRAM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_HITM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_FWD
...
Mem_L3_Hit_Fraction = MEM_LOAD_UOPS_RETIRED.L3_HIT / (MEM_LOAD_UOPS_RETIRED.L3_HIT + Mem_L3_Weight * MEM_LOAD_UOPS_RETIRED.L3_MISS)
CLKS = CPU_CLK_UNHALTED.THREAD
DRAM_Bound = (1 - Mem_L3_Hit_Fraction) * CYCLE_ACTIVITY.STALLS_L2_MISS / CLKS
```
...
LOAD_L1_MISS = MEM_LOAD_UOPS_RETIRED.L2_HIT + MEM_LOAD_UOPS_RETIRED.L3_HIT + MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HIT + MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HITM + MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_MISS
LOAD_L1_MISS_NET = LOAD_L1_MISS + MEM_LOAD_UOPS_L3_MISS_RETIRED.LOCAL_DRAM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_DRAM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_HITM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_FWD
LOAD_LCL_MEM = MEM_LOAD_UOPS_L3_MISS_RETIRED.LOCAL_DRAM * (1 + MEM_LOAD_UOPS_RETIRED.HIT_LFB / LOAD_L1_MISS_NET)
...
LOAD_L1_MISS = MEM_LOAD_UOPS_RETIRED.L2_HIT + MEM_LOAD_UOPS_RETIRED.L3_HIT + MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HIT + MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HITM + MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_MISS
LOAD_L1_MISS_NET = LOAD_L1_MISS + MEM_LOAD_UOPS_L3_MISS_RETIRED.LOCAL_DRAM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_DRAM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_HITM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_FWD
LOAD_RMT_MEM = MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_DRAM * (1 + MEM_LOAD_UOPS_RETIRED.HIT_LFB / LOAD_L1_MISS_NET)
...
LOAD_L1_MISS = MEM_LOAD_UOPS_RETIRED.L2_HIT + MEM_LOAD_UOPS_RETIRED.L3_HIT + MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HIT + MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HITM + MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_MISS
LOAD_L1_MISS_NET = LOAD_L1_MISS + MEM_LOAD_UOPS_L3_MISS_RETIRED.LOCAL_DRAM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_DRAM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_HITM + MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_FWD
LOAD_RMT_FWD = MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_FWD * (1 + MEM_LOAD_UOPS_RETIRED.HIT_LFB / LOAD_L1_MISS_NET)
LOAD_RMT_HITM = MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_HITM * (1 + MEM_LOAD_UOPS_RETIRED.HIT_LFB / LOAD_L1_MISS_NET)
...
```python
CLKS = CPU_CLK_UNHALTED.THREAD
DTLB_Store = (Mem_STLB_Hit_Cost * DTLB_STORE_MISSES.STLB_HIT + DTLB_STORE_MISSES.WALK_DURATION:c1 + 7 * DTLB_STORE_MISSES.WALK_COMPLETED) / CLKS
```
...
Frontend_RS_Empty_Cycles = RS_EVENTS.EMPTY_CYCLES if Fetch_Latency > 0.1 else 0
Backend_Bound_Cycles = CYCLE_ACTIVITY.STALLS_TOTAL + UOPS_EXECUTED.CYCLES_GE_1_UOP_EXEC - Few_Uops_Executed_Threshold - Frontend_RS_Empty_Cycles + RESOURCE_STALLS.SB
Ports_Utilization = (Backend_Bound_Cycles - RESOURCE_STALLS.SB - CYCLE_ACTIVITY.STALLS_MEM_ANY) / CLKS
```
...
CORE_CLKS = CPU_CLK_UNHALTED.THREAD / 2 * (1 + CPU_CLK_UNHALTED.ONE_THREAD_ACTIVE / CPU_CLK_UNHALTED.REF_XCLK) if ebs_mode else CPU_CLK_UNHALTED.THREAD_ANY / 2 if smt_enabled else CLKS
Frontend_RS_Empty_Cycles = RS_EVENTS.EMPTY_CYCLES if Fetch_Latency > 0.1 else 0
Cycles_0_Ports_Utilized = UOPS_EXECUTED.CORE:i1:c1 / 2 if smt_enabled else CYCLE_ACTIVITY.STALLS_TOTAL - Frontend_RS_Empty_Cycles
...
## 5.3 <a id="metric_iparith_avx128">Metric_IpArith_AVX128</a>
...
## 5.4 <a id="metric_dram_bw_use">Metric_DRAM_BW_Use</a>
...
## 5.5 <a id="metric_ipcall">Metric_IpCall</a>
...
## 5.6 <a id="metric_l2mpki_load">Metric_L2MPKI_Load</a>
...
## 5.7 <a id="metric_ipload">Metric_IpLoad</a>
...
## 5.8 <a id="metric_execute">Metric_Execute</a>
...
## 5.9 <a id="metric_l2_cache_fill_bw_1t">Metric_L2_Cache_Fill_BW_1T</a>
...
## 5.10 <a id="metric_l1d_cache_fill_bw_1t">Metric_L1D_Cache_Fill_BW_1T</a>
...
## 5.11 <a id="metric_slots">Metric_SLOTS</a>
...
## 5.12 <a id="metric_l3_cache_fill_bw">Metric_L3_Cache_Fill_BW</a>
...
## 5.13 <a id="metric_smt_2t_utilization">Metric_SMT_2T_Utilization</a>
...
## 5.14 <a id="metric_mem_read_latency">Metric_MEM_Read_Latency</a>
...
MEM_Read_Latency = OneBillion * (UNC_C_TOR_OCCUPANCY.MISS_OPCODE:opc=0x182 / UNC_C_TOR_INSERTS.MISS_OPCODE:opc=0x182) / (Socket_CLKS / Time)
...
## 5.15 <a id="metric_load_l2_miss_latency">Metric_Load_L2_Miss_Latency</a>
...
## 5.16 <a id="metric_ipstore">Metric_IpStore</a>
...
## 5.17 <a id="metric_uoppi">Metric_UopPI</a>
...
## 5.18 <a id="metric_l2hpki_all">Metric_L2HPKI_All</a>
...
## 5.19 <a id="metric_turbo_utilization">Metric_Turbo_Utilization</a>
...
## 5.20 <a id="metric_data_l2_mlp">Metric_Data_L2_MLP</a>
...
## 5.21 <a id="metric_page_walks_utilization">Metric_Page_Walks_Utilization</a>
...
CLKS = CPU_CLK_UNHALTED.THREAD
CORE_CLKS = CPU_CLK_UNHALTED.THREAD / 2 * (1 + CPU_CLK_UNHALTED.ONE_THREAD_ACTIVE / CPU_CLK_UNHALTED.REF_XCLK) if ebs_mode else CPU_CLK_UNHALTED.THREAD_ANY / 2 if smt_enabled else CLKS
Page_Walks_Utilization = (ITLB_MISSES.WALK_DURATION + DTLB_LOAD_MISSES.WALK_DURATION + DTLB_STORE_MISSES.WALK_DURATION + 7 * (DTLB_STORE_MISSES.WALK_COMPLETED + DTLB_LOAD_MISSES.WALK_COMPLETED + ITLB_MISSES.WALK_COMPLETED)) / (2 * CORE_CLKS)
...
## 5.22 <a id="metric_fp_arith_utilization">Metric_FP_Arith_Utilization</a>
...
## 5.23 <a id="metric_core_clks">Metric_CORE_CLKS</a>
...
## 5.24 <a id="metric_l2hpki_load">Metric_L2HPKI_Load</a>
...
## 5.25 <a id="metric_l2mpki">Metric_L2MPKI</a>
...
## 5.26 <a id="metric_l1mpki">Metric_L1MPKI</a>
...
## 5.27 <a id="metric_ilp">Metric_ILP</a>
...
## 5.28 <a id="metric_ipunknown_branch">Metric_IpUnknown_Branch</a>
...
## 5.29 <a id="metric_ipfarbranch">Metric_IpFarBranch</a>
...
## 5.30 <a id="metric_kernel_utilization">Metric_Kernel_Utilization</a>
...
## 5.31 <a id="metric_cpu_utilization">Metric_CPU_Utilization</a>
...
## 5.32 <a id="metric_mem_parallel_reads">Metric_MEM_Parallel_Reads</a>
...
```python
MEM_Parallel_Reads = UNC_C_TOR_OCCUPANCY.MISS_OPCODE:opc=0x182 / UNC_C_TOR_OCCUPANCY.MISS_OPCODE:opc=0x182:c1
...
## 5.34 <a id="metric_mlp">Metric_MLP</a>
...
## 5.36 <a id="metric_gflops">Metric_GFLOPs</a>
...
## 5.37 <a id="metric_iparith_scalar_sp">Metric_IpArith_Scalar_SP</a>
...
## 5.38 <a id="metric_socket_clks">Metric_Socket_CLKS</a>
...
## 5.39 <a id="metric_ipc">Metric_IPC</a>
...
## 5.40 <a id="metric_ipmisp_indirect">Metric_IpMisp_Indirect</a>
...
## 5.41 <a id="metric_ipflop">Metric_IpFLOP</a>
...
## 5.44 <a id="metric_l2_cache_fill_bw">Metric_L2_Cache_Fill_BW</a>
...
## 5.45 <a id="metric_ipbranch">Metric_IpBranch</a>
...
## 5.46 <a id="metric_branch_misprediction_cost">Metric_Branch_Misprediction_Cost</a>
...
## 5.47 <a id="metric_coreipc">Metric_CoreIPC</a>
...
## 5.48 <a id="metric_iparith">Metric_IpArith</a>
...
## 5.49 <a id="metric_l2mpki_all">Metric_L2MPKI_All</a>
...
## 5.50 <a id="metric_load_miss_real_latency">Metric_Load_Miss_Real_Latency</a>
...
## 5.51 <a id="metric_l3_cache_fill_bw_1t">Metric_L3_Cache_Fill_BW_1T</a>
...
## 5.52 <a id="metric_average_frequency">Metric_Average_Frequency</a>
...
## 5.53 <a id="metric_clks">Metric_CLKS</a>
...
## 5.54 <a id="metric_iptb">Metric_IpTB</a>
...
## 5.55 <a id="metric_dsb_coverage">Metric_DSB_Coverage</a>
...
## 5.56 <a id="metric_bptkbranch">Metric_BpTkBranch</a>
...
## 5.57 <a id="metric_load_l2_mlp">Metric_Load_L2_MLP</a>
...
## 5.58 <a id="metric_time">Metric_Time</a>
...
## 5.59 <a id="metric_execute_per_issue">Metric_Execute_per_Issue</a>
...
## 5.60 <a id="metric_ipmispredict">Metric_IpMispredict</a>
...
## 5.61 <a id="metric_l1d_cache_fill_bw">Metric_L1D_Cache_Fill_BW</a>
...
## 5.62 <a id="metric_iparith_avx256">Metric_IpArith_AVX256</a>
...
## 5.63 <a id="metric_retire">Metric_Retire</a>
...
## 5.64 <a id="metric_l3mpki">Metric_L3MPKI</a>
